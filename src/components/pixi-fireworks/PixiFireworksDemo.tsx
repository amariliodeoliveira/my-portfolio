    ...
    >
      <header className="mx-auto max-w-3xl text-center">
        ...
        <p className="text-base-content/80 leading-relaxed">
          ...
          PixiJS. The project uses WebGL rendering for the visual layer, parses
          scheduled Rocket and Fountain effects from structured XML, loops the
          show from the beginning, and keeps the animation independent from the
          browser frame rate.
        </p>
      ...
      >
        <div className="mx-auto mb-4 max-w-2xl text-center">
          ...
          <p className="text-base-content/70 mt-2 text-sm leading-relaxed">
            ...
            the engineering details behind a canvas experience: parsing external
            data, scheduling effects, rendering particles, and keeping the code
            organized enough to extend.
          </p>
        </div>
